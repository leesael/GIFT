...
2. Usage
	...
	[Step 1] Install Armadillo, LAPACK, and BLAS libraries.
 	...
 	[Step 2] Compile and run GIFT.
		...
		The executable file takes 7 arguments, which are the path of input tensor file, path of a mask matrix, path of directory for storing results, tensor order, lambda, tensor rank. The arguments MUST BE valid and in the above order.
